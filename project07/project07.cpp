...
int main()
{
    ...
    // 반복 해야할 회수가 명확하지 않을 때 주로 사용한다
    /*
    while(조건식)      세미콜론;을 찍으면 무한 반복이라 찍지 않는다
    {
        반복 실행할 명령문(들)...
    }
    */
    ...
    ...
    ...
    2 x 9 = 18  3 x 8 = 27  4 x 9 = 36 ... 9 x 9 = 81
    */
